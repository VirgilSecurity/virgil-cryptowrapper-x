Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.16.2'
  s.dependency 'VSCCrypto/Common', '= 0.16.2'
  s.dependency 'VSCCrypto/Foundation', '= 0.16.2'
  s.dependency 'VSCCrypto/Ratchet', '= 0.16.2'
end
