Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.5.1'
  s.dependency 'VSCCrypto/Common', '= 0.5.0'
  s.dependency 'VSCCrypto/Foundation', '= 0.5.0'
  s.dependency 'VSCCrypto/Ratchet', '= 0.5.0'
end
