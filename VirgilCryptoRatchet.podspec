Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.7.0'
  s.dependency 'VSCCrypto/Common', '= 0.7.0'
  s.dependency 'VSCCrypto/Foundation', '= 0.7.0'
  s.dependency 'VSCCrypto/Ratchet', '= 0.7.0'
end
