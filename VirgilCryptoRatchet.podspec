Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.7.1'
  s.dependency 'VSCCrypto/Common', '= 0.7.1'
  s.dependency 'VSCCrypto/Foundation', '= 0.7.1'
  s.dependency 'VSCCrypto/Ratchet', '= 0.7.1'
end
