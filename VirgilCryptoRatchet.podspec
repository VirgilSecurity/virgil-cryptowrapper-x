Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.8.1'
  s.dependency 'VSCCrypto/Common', '= 0.8.1'
  s.dependency 'VSCCrypto/Foundation', '= 0.8.1'
  s.dependency 'VSCCrypto/Ratchet', '= 0.8.1'
end
