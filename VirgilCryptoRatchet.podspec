Pod::Spec.new do |s|
  ...
  s.dependency 'VirgilCryptoFoundation', '= 0.11.1'
  s.dependency 'VSCCrypto/Common', '= 0.11.0'
  s.dependency 'VSCCrypto/Foundation', '= 0.11.0'
  s.dependency 'VSCCrypto/Ratchet', '= 0.11.0'
end
